...
/** Tab bar height in app/(tabs)/_layout.tsx — keep tap layer above the menu. */
export const TAB_BAR_HEIGHT = 76;

type UseDuaCountGesturesOptions = {
  onBump: (x: number, y: number, times?: number) => void;
  enabled?: boolean;
  /** Tasbeeh list: only a completed double tap counts once. Detail screen keeps tap, double (+2), hold. */
